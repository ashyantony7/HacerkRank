...
int equalStacks(vector<int> h1, vector<int> h2, vector<int> h3) {
    ...
    long height=0; // int to store current heights

    // fill stacks with increasing heights
    // this problem gives values from top to bottom
    // therefore we need to add in reverse order
    ...
    while ((s1.top()!=s2.top()) || (s1.top()!=s3.top()) || (s2.top()!=s3.top())){
        ...
        // if any stack becomes empty break
